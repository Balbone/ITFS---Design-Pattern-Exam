...
Un esempio di utilizzo delle classi sopra citate ci è fornito dal cient {\tt DemoAnimalShelter.java} riportato in appendice \ref{appendice:A}. Sempre in appendice \ref{appendice:A} si può osservare il semplice e chiaro output del client.
\newpage
\printbibliography
...
\begin{figure}[!t]
    \makebox[\textwidth][c]{\includegraphics[width=1.2\linewidth]{immagini/output_base.png}}
