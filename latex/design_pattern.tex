...
L'{\em UC diagram} è una “interfaccia” astratta della nostra applicazione, che descrive un possibile {\em use case}, ossia un possibile scenario di utilizzo dell'applicazione.
...
\begin{figure}[h]
  \centering
   \makebox[\textwidth][c]{\includesvg[width= 1.4\linewidth]{UC_diagram.svg}}
  \caption{Esempio di UC diagram relativo all'applicazione del negozio online.}
