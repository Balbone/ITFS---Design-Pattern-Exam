...
%bibliography
\usepackage[sorting=none,isbn=false,url=false,eprint=false]{biblatex}
...
L'{\em UC diagram} è una “interfaccia” astratta della nostra applicazione, che descrive un possibile {\em caso d'uso}, ossia un possibile scenario di utilizzo dell'applicazione, fig. \ref{fig:UC_diagram}.
...
\davide{Materiale da citare: \cite{gof_riferimento}, \cite{up-riferimento}, \cite{uml_riferimento}, \cite{elicitation_tools}, \cite{gof_sunt}.}
